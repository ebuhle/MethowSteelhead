...
if(file.exists(here("analysis","results","MethowSH_stanfit.RData"))) 
  load(here("analysis","results","MethowSH_stanfit.RData"))
...
dev.new()
# png(filename=here("analysis","results","fitted_ocean_age.png"), width=7, height=7, units="in", res=300, type="cairo-png")
...
dev.new()
# png(filename=here("analysis","results","adult_age.png"), width=7, height=7, units="in", res=300, type="cairo-png")
par(mar = c(5,5,4,1))
...
# Posterior predictive checking for CJS models based on aggregated array cell proportions
...
# png(filename=here("analysis","results","pp_agg-array.png"), width=7, height=7, units="in", res=300, type="cairo-png")
plot(apply(nm[,as.character(1:cjs_ppd_iter)], 1, median)/sum(nm$n), nm$n/sum(nm$n), 
     ...
     xlab = "Predicted cell proportion", ylab = "Observed cell proportion",
     main = "Data and posterior predictive distribution")
abline(0,1)
...
epsilon_z <- matrix(stan_mean(cjs_fixNA3,"epsilon_z"), ncol = 6, byrow = T)
occ_names <- c("WNFH","RRJ","MCJTWX","BOA","TDAWEA","LMR")

dev.new(width = 4, height = 8)
# png(filename=here("analysis","results","posteriors_phi.png"), width=4, height=8, units="in", res=300, type="cairo-png")
...
e_z <- matrix(stan_mean(cjs_fixNA3,"e_z"), ncol = 7, byrow = T)

dev.new(width = 7, height = 7)
# png(filename=here("analysis","results","posteriors_p.png"), width=7, height=7, units="in", res=300, type="cairo-png")
...
dev.new(width = 7, height = 7)
# png(filename=here("analysis","results","reach_phi_S1vS2.png"), width=7, height=7, units="in", res=300, type="cairo-png")
...
dev.new(width = 7, height = 7)
# png(filename=here("analysis","results","reach_phi_adult_age.png"), width=7, height=7, units="in", res=300, type="cairo-png")
...
dev.new(width = 7, height = 7)
# png(filename=here("analysis","results","phi_tot.png"), width=7, height=7, units="in", res=300, type="cairo-png")
