...
```{r CJS.stan, echo = FALSE}
writeLines(readLines(here("analysis","stan","CJS.stan")))
```
...
```{r CJS-phiXRE-pXRE-fixNA.stan, echo = FALSE}
writeLines(readLines(here("analysis","stan","CJS-phiXRE-pXRE-fixNA.stan")))
```
