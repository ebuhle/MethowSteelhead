...
# Data
len <- unlist(read.csv(here("data","MethowSPCH-Lengths2017.csv"), header = T))
log_len <- log(len)
...
png(filename=here("analysis","results","SE_mu_sigma_log_length.png"), width=7, height=10, units="in", res=300, type="cairo-png")
